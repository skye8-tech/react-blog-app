  ...
  const handleCreateAccount = async (event) => {
    ...
    try {
      const result = await axios.post(
        "https://blog-api-zk5m.onrender.com/v1/users/create",
        userInfo
      );
    ...
    <div className="w-screen h-screen grid grid-cols-2 max-[640px]:grid-cols-1">
      ...
      <div className=" bg-[var(--light-color)] flex items-center justify-center max-[640px]:hidden">
        ...
        >
          ...
          />
          <path
            id="uuid-31bdf68e-d938-48b7-86ad-7ba8e8b265d3-91-89-41-96"
          ...
          />
          <path
            id="uuid-0d1d7be6-7e67-43a2-9b15-a4bbed67d7bc-92-90-42-97"

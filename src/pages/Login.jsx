      ...
      <div className="bg-white flex flex-col justify-center gap-y-8 px-4">
        ...
        <form method="post">
          ...
          <div className="w-[80%] mx-auto flex justify-between px-4 text-[var(--dark-color)]">
            <p className=" text-black">Haven't created account yet?</p>
      ...
      <div className=" bg-[var(--light-color)] flex items-center justify-center max-[640px]:hidden">
        ...
        >
          ...
          <path
            ...
            fill="#ccc"
          />
          <circle cx="477.63839" cy="248.74781" r="9" fill="#d5bbfc" />
          <path
            ...
            fill="#2f2e41"
          />
          <circle cx="412.98633" cy="41.44344" r="19.89355" fill="#a0616a" />
          <path
            ...
            fill="#2f2e41"
          />
          <circle cx="434.11663" cy="13.10599" r="13.10599" fill="#2f2e41" />
          <path
